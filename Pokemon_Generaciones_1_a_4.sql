...
CREATE TABLE Pokemon (
    ...
    FaseEvolutiva INT NOT NULL CHECK (FaseEvolutiva BETWEEN 1 AND 3),
...
INSERT INTO Pokemon (ID, Nombre, Generacion, FaseEvolutiva, Tipo1, Tipo2, HP, Ataque, Defensa, Velocidad) VALUES
(1, 'Bulbasaur', 1, 1, 'Planta', 'Veneno', 45, 49, 49, 45),
(2, 'Ivysaur', 1, 2, 'Planta', 'Veneno', 60, 62, 63, 60),
(3, 'Venusaur', 1, 3, 'Planta', 'Veneno', 80, 82, 83, 80),
(4, 'Charmander', 1, 1, 'Fuego', NULL, 39, 52, 43, 65),
(5, 'Charmeleon', 1, 2, 'Fuego', NULL, 58, 64, 58, 80),
(6, 'Charizard', 1, 3, 'Fuego', 'Volador', 78, 84, 78, 100),
(7, 'Squirtle', 1, 1, 'Agua', NULL, 44, 48, 65, 43),
(8, 'Wartortle', 1, 2, 'Agua', NULL, 59, 63, 80, 58),
(9, 'Blastoise', 1, 3, 'Agua', NULL, 79, 83, 100, 78),
(10, 'Caterpie', 1, 1, 'Bicho', NULL, 45, 30, 35, 45),
(11, 'Metapod', 1, 2, 'Bicho', NULL, 50, 20, 55, 30),
(12, 'Butterfree', 1, 3, 'Bicho', 'Volador', 60, 45, 50, 70),
(13, 'Weedle', 1, 1, 'Bicho', 'Veneno', 40, 35, 30, 50),
(14, 'Kakuna', 1, 2, 'Bicho', 'Veneno', 45, 25, 50, 35),
(15, 'Beedrill', 1, 3, 'Bicho', 'Veneno', 65, 90, 40, 75),
(16, 'Pidgey', 1, 1, 'Normal', 'Volador', 40, 45, 40, 56),
(17, 'Pidgeotto', 1, 2, 'Normal', 'Volador', 63, 60, 55, 71),
(18, 'Pidgeot', 1, 3, 'Normal', 'Volador', 83, 80, 75, 101),
(19, 'Rattata', 1, 1, 'Normal', NULL, 30, 56, 35, 72),
(20, 'Raticate', 1, 2, 'Normal', NULL, 55, 81, 60, 97),
(22, 'Fearow', 1, 2, 'Normal', 'Volador', 65, 90, 65, 100),
(23, 'Ekans', 1, 1, 'Veneno', NULL, 35, 60, 44, 55),
INSERT INTO Pokemon (ID, Nombre, Generacion, FaseEvolutiva, Tipo1, Tipo2, HP, Ataque, Defensa, Velocidad) VALUES
(25, 'Pikachu', 1, 2, 'Eléctrico', NULL, 35, 55, 40, 90),
(26, 'Raichu', 1, 3, 'Eléctrico', NULL, 60, 90, 55, 110),
(41, 'Zubat', 1, 1, 'Veneno', 'Volador', 40, 45, 35, 55),
(42, 'Golbat', 1, 2, 'Veneno', 'Volador', 75, 80, 70, 90),
(54, 'Psyduck', 1, 1, 'Agua', NULL, 50, 52, 48, 55),
(55, 'Golduck', 1, 2, 'Agua', NULL, 80, 82, 78, 85),
(92, 'Gastly', 1, 1, 'Fantasma', 'Veneno', 30, 35, 30, 80),
(93, 'Haunter', 1, 2, 'Fantasma', 'Veneno', 45, 50, 45, 95),
(94, 'Gengar', 1, 3, 'Fantasma', 'Veneno', 60, 65, 60, 110),
(111, 'Rhyhorn', 1, 1, 'Tierra', 'Roca', 80, 85, 95, 25),
(112, 'Rhydon', 1, 2, 'Tierra', 'Roca', 105, 130, 120, 40),
(142, 'Aerodactyl', 1, 1, 'Roca', 'Volador', 80, 105, 65, 130);

-- Inserción de pokemons de la segunda generación
INSERT INTO Pokemon (ID, Nombre, Generacion, FaseEvolutiva, Tipo1, Tipo2, HP, Ataque, Defensa, Velocidad) VALUES
(152, 'Chikorita', 2, 1, 'Planta', NULL, 45, 49, 65, 45),
(153, 'Bayleef', 2, 2, 'Planta', NULL, 60, 62, 80, 60),
(154, 'Meganium', 2, 3, 'Planta', NULL, 80, 82, 100, 80),
(155, 'Cyndaquil', 2, 1, 'Fuego', NULL, 39, 52, 43, 65),
(156, 'Quilava', 2, 2, 'Fuego', NULL, 58, 64, 58, 80),
(157, 'Typhlosion', 2, 3, 'Fuego', NULL, 78, 84, 78, 100),
(158, 'Totodile', 2, 1, 'Agua', NULL, 50, 65, 64, 43),
(159, 'Croconaw', 2, 2, 'Agua', NULL, 65, 80, 80, 58),
(160, 'Feraligatr', 2, 3, 'Agua', NULL, 85, 105, 100, 78),
(161, 'Sentret', 2, 1, 'Normal', NULL, 35, 46, 34, 20),
(162, 'Furret', 2, 2, 'Normal', NULL, 85, 76, 64, 90),
(172, 'Pichu', 2, 1, 'Eléctrico', NULL, 20, 40, 15, 60),
(173, 'Cleffa', 2, 1, 'Hada', NULL, 50, 25, 28, 15),
(174, 'Clefairy', 2, 2, 'Hada', NULL, 70, 45, 48, 35),
(175, 'Togepi', 2, 1, 'Hada', NULL, 35, 20, 65, 20),
(176, 'Togetic', 2, 2, 'Hada', 'Volador', 55, 40, 85, 40),
(182, 'Bellossom', 2, 3, 'Planta', NULL, 75, 80, 95, 50),
(185, 'Sudowoodo', 2, 2, 'Roca', NULL, 70, 100, 115, 30),
(193, 'Yamask', 2, 1, 'Fantasma', NULL, 38, 40, 85, 30),
(198, 'Murkrow', 2, 1, 'Siniestro', 'Volador', 60, 85, 42, 91),
(202, 'Wobbuffet', 2, 2, 'Psíquico', NULL, 190, 33, 58, 33),
(214, 'Heracross', 2, 1, 'Bicho', 'Lucha', 80, 125, 75, 85),
(216, 'Teddiursa', 2, 1, 'Normal', NULL, 60, 80, 50, 40),
(217, 'Ursaring', 2, 2, 'Normal', NULL, 90, 130, 75, 55),
(236, 'Tyrogue', 2, 1, 'Lucha', NULL, 35, 35, 35, 35),
(237, 'Hitmontop', 2, 2, 'Lucha', NULL, 50, 95, 95, 35),
(246, 'Larvitar', 2, 1, 'Roca', 'Tierra', 50, 64, 50, 41),
(247, 'Pupitar', 2, 2, 'Roca', 'Tierra', 70, 84, 70, 51),
(248, 'Tyranitar', 2, 3, 'Roca', 'Siniestro', 100, 134, 110, 61);

-- Inserción de datos de la tercera generación
INSERT INTO Pokemon (ID, Nombre, Generacion, FaseEvolutiva, Tipo1, Tipo2, HP, Ataque, Defensa, Velocidad) VALUES
(252, 'Treecko', 3, 1, 'Planta', NULL, 40, 45, 35, 70),
(253, 'Grovyle', 3, 2, 'Planta', NULL, 50, 65, 45, 95),
(254, 'Sceptile', 3, 3, 'Planta', NULL, 70, 85, 65, 120),
(255, 'Torchic', 3, 1, 'Fuego', NULL, 45, 60, 40, 45),
(256, 'Combusken', 3, 2, 'Fuego', 'Lucha', 60, 85, 60, 55),
(257, 'Blaziken', 3, 3, 'Fuego', 'Lucha', 80, 120, 70, 80),
(258, 'Mudkip', 3, 1, 'Agua', NULL, 50, 70, 50, 40),
(259, 'Marshtomp', 3, 2, 'Agua', 'Tierra', 70, 85, 70, 50),
(260, 'Swampert', 3, 3, 'Agua', 'Tierra', 100, 110, 90, 60),
(261, 'Poochyena', 3, 1, 'Siniestro', NULL, 35, 55, 35, 35),
(262, 'Mightyena', 3, 2, 'Siniestro', NULL, 70, 90, 70, 70),
(273, 'Seedot', 3, 1, 'Planta', NULL, 40, 40, 50, 30),
(274, 'Nuzleaf', 3, 2, 'Planta', 'Siniestro', 70, 70, 40, 60),
(275, 'Shiftry', 3, 3, 'Planta', 'Siniestro', 90, 100, 60, 80),
(280, 'Ralts', 3, 1, 'Psíquico', 'Hada', 28, 25, 25, 40),
(281, 'Kirlia', 3, 2, 'Psíquico', 'Hada', 38, 35, 35, 50),
(282, 'Gardevoir', 3, 3, 'Psíquico', 'Hada', 68, 65, 65, 80),
(301, 'Skitty', 3, 1, 'Normal', NULL, 50, 45, 45, 50),
(302, 'Delcatty', 3, 2, 'Normal', NULL, 70, 65, 65, 70),
(324, 'Trapinch', 3, 1, 'Tierra', NULL, 45, 100, 45, 10),
(325, 'Vibrava', 3, 2, 'Tierra', 'Dragón', 50, 70, 50, 70),
(326, 'Flygon', 3, 3, 'Tierra', 'Dragón', 80, 100, 80, 100),
(333, 'Swablu', 3, 1, 'Normal', 'Volador', 45, 40, 60, 50),
(334, 'Altaria', 3, 2, 'Dragón', 'Volador', 75, 70, 90, 80),
(361, 'Snorunt', 3, 1, 'Hielo', NULL, 50, 50, 50, 50),
(362, 'Glalie', 3, 2, 'Hielo', NULL, 80, 80, 80, 80);

-- Inserción de datos de la cuarta generación
INSERT INTO Pokemon (ID, Nombre, Generacion, FaseEvolutiva, Tipo1, Tipo2, HP, Ataque, Defensa, Velocidad) VALUES
(387, 'Turtwig', 4, 1, 'Planta', NULL, 55, 68, 64, 31),
(388, 'Grotle', 4, 2, 'Planta', NULL, 75, 89, 85, 36),
(389, 'Torterra', 4, 3, 'Planta', 'Tierra', 95, 109, 105, 56),
(390, 'Chimchar', 4, 1, 'Fuego', NULL, 44, 58, 44, 61),
(391, 'Monferno', 4, 2, 'Fuego', 'Lucha', 64, 78, 52, 81),
(392, 'Infernape', 4, 3, 'Fuego', 'Lucha', 76, 104, 71, 108),
(393, 'Piplup', 4, 1, 'Agua', NULL, 53, 51, 53, 40),
(394, 'Prinplup', 4, 2, 'Agua', NULL, 64, 66, 68, 50),
(395, 'Empoleon', 4, 3, 'Agua', 'Acero', 84, 86, 88, 60),
(396, 'Starly', 4, 1, 'Normal', 'Volador', 40, 55, 30, 60),
(397, 'Staravia', 4, 2, 'Normal', 'Volador', 55, 75, 50, 80),
(398, 'Staraptor', 4, 3, 'Normal', 'Volador', 85, 120, 70, 100),
(403, 'Shinx', 4, 1, 'Eléctrico', NULL, 45, 65, 34, 45),
(404, 'Luxio', 4, 2, 'Eléctrico', NULL, 60, 85, 49, 60),
(405, 'Luxray', 4, 3, 'Eléctrico', NULL, 80, 120, 79, 70),
(406, 'Budew', 4, 1, 'Planta', 'Veneno', 40, 30, 35, 60),
(407, 'Roserade', 4, 2, 'Planta', 'Veneno', 60, 70, 65, 65),
(413, 'Wormadam', 4, 2, 'Bicho', 'Planta', 60, 59, 85, 36),
(414, 'Mothim', 4, 2, 'Bicho', 'Volador', 70, 65, 60, 66),
(419, 'Cherubi', 4, 1, 'Planta', NULL, 45, 35, 45, 35),
(420, 'Cherrim', 4, 2, 'Planta', NULL, 70, 60, 70, 85),
(423, 'Gastrodon', 4, 2, 'Agua', 'Tierra', 111, 83, 68, 39),
(425, 'Drifloon', 4, 1, 'Fantasma', 'Volador', 90, 50, 34, 40),
(426, 'Drifblim', 4, 2, 'Fantasma', 'Volador', 150, 80, 44, 90),
(428, 'Buneary', 4, 1, 'Normal', NULL, 55, 66, 44, 85),
(430, 'Honchkrow', 4, 2, 'Siniestro', 'Volador', 100, 125, 52, 71),
(443, 'Gible', 4, 1, 'Dragón', 'Tierra', 58, 70, 45, 42),
(444, 'Gabite', 4, 2, 'Dragón', 'Tierra', 68, 90, 65, 82),
(445, 'Garchomp', 4, 3, 'Dragón', 'Tierra', 108, 130, 95, 102),
(478, 'Froslass', 4, 2, 'Hielo', 'Fantasma', 70, 80, 70, 110);
